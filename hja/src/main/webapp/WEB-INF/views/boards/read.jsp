                ...
                <article class="post">
                    <header class="blog-entry-heading">
                        ...
                        <nav class="post-nav post-nav-top">
    						<span class="nav-previous"><a href="/boards/read?bno=${boardVO.bno-1}" rel="prev"><i class="fa fa-long-arrow-left"></i>Previous post</a></span>
    						<span class="nav-next"><a href="/boards/read?bno=${boardVO.bno+1}" rel="next">Next post<i class="fa fa-long-arrow-right"></i></a></span>
    				    </nav><!--//post-nav-->
