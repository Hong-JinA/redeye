...
<body class="blog-page">
    ...
    <div class="wrapper">
        ...
        <section class="featured-blog-posts section">       
            ...
            <div class="searchbox-container" style="width:200px; float:right; margin-right: 400px">
                	   ...
                	   <article class="post col-md-4 col-sm-6 col-xs-12">
                        <div class="post-inner">
                            <figure class="post-thumb">
                                <a href="/boards/readPage${pageMaker.makeQuery(pageMaker.cri.page)}&bno=${boardVO.bno}"><img src="/resources/assets/images/blog/post-1-thumb.jpg" alt="" /></a>                                
                            </figure><!--//post-thumb-->
                            <div class="content">
                                <h3 class="post-title"><a href="/boards/readPage${pageMaker.makeQuery(pageMaker.cri.page)}&bno=${boardVO.bno}">${boardVO.title}</a></h3>
                                <div class="post-entry">
                                    <p>${boardVO.content }</p>
                                    <a class="read-more" href="/boards/readPage${pageMaker.makeQuery(pageMaker.cri.page)}&bno=${boardVO.bno}">Read more <i class="fa fa-long-arrow-right"></i></a>
                                </div>
                                <div class="meta">
                ...
                <ul class="pagination">
                   <c:choose>
                            	<c:when test="${pageMaker.prev }">
                            		<li><a href="/boards/listPage${pageMaker.makeQuery(pageMaker.startPage - 1) }">&laquo;</a></li>
                            	</c:when>
                            	<c:otherwise>
							...
							<c:forEach begin="${pageMaker.startPage }" 
								...
								<a href="/boards/listPage${pageMaker.makeQuery(idx) }">${idx}</a>
								</li>
							
							</c:forEach>
							<c:choose>
                            	<c:when test="${pageMaker.next }">
                            		<li><a href="/boards/listPage${pageMaker.makeQuery(pageMaker.endPage + 1) }">&raquo;</a></li>
                            	</c:when>
                            	<c:otherwise>
