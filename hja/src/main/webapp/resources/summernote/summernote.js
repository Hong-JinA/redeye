...
(function (factory) {
  ...
  var editor = renderer.create('<div class="sjb note-editor note-frame panel panel-default"/>');
  var toolbar = renderer.create('<div class="sjb note-toolbar panel-heading"/>');
  var editingArea = renderer.create('<div class="sjb note-editing-area"/>');
  var codable = renderer.create('<textarea class="sjb note-codable"/>');
  var editable = renderer.create('<div class="sjb note-editable panel-body" contentEditable="true"/>');
  var statusbar = renderer.create([
    '<div class="sjb note-statusbar">',
    '  <div class="sjb note-resizebar">',
    '    <div class="sjb note-icon-bar"/>',
    '    <div class="sjb note-icon-bar"/>',
    '    <div class="sjb note-icon-bar"/>',
    '  </div>',
    '</div>'
  ...
  var airEditor = renderer.create('<div class="sjb note-editor"/>');
  var airEditable = renderer.create('<div class="sjb note-editable" contentEditable="true"/>');

  var buttonGroup = renderer.create('<div class="sjb note-btn-group btn-group">');

  var dropdown = renderer.create('<div class="sjb dropdown-menu">', function ($node, options) {
  ...
  var dropdownCheck = renderer.create('<div class="sjb dropdown-menu note-check">', function ($node, options) {
    var markup = $.isArray(options.items) ? options.items.map(function (item) {
      var value = (typeof item === 'string') ? item : (item.value || '');
      var content = options.template ? options.template(item) : item;
  ...
  var palette = renderer.create('<div class="sjb note-color-palette"/>', function ($node, options) {
    var contents = [];
    for (var row = 0, rowSize = options.colors.length; row < rowSize; row++) {
      ...
      for (var col = 0, colSize = colors.length; col < colSize; col++) {
        ...
        buttons.push([
          '<button type="button" class="sjb note-color-btn"',
      ...
      contents.push('<div class="sjb note-color-row">' + buttons.join('') + '</div>');
    }
  ...
  var dialog = renderer.create('<div class="sjb modal" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
    if (options.fade) {
      $node.addClass('fade');
    }
    $node.html([
      '<div class="sjb modal-dialog">',
      '  <div class="sjb modal-content">',
      (options.title ?
      '    <div class="sjb modal-header">' +
      '      <button type="button" class="sjb close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>' +
      '      <h4 class="sjb modal-title">' + options.title + '</h4>' +
      '    </div>' : ''
      ),
      '    <div class="sjb modal-body">' + options.body + '</div>',
      (options.footer ?
      '    <div class="sjb modal-footer">' + options.footer + '</div>' : ''
      ),
      '  </div>',
      '</div>'
    ].join(''));
  ...
  var popover = renderer.create([
    '<div class="sjb note-popover popover in" style="display: none;">',
    '  <div class="sjb arrow"/>',
    '  <div class="sjb popover-content note-children-container"/>',
    '</div>'
  ...
  var checkbox = renderer.create('<div class="sjb checkbox"></div>', function ($node, options) {
      $node.html([
  ...
  var icon = function (iconClassName, tagName) {
    tagName = tagName || 'i';
    return '<' + tagName + ' class="sjb ' + iconClassName + '"/>';
  };
  ...
  var ui = {
    ...
    button: function ($node, options) {
      return renderer.create('<button type="button" class="sjb note-btn btn btn-default btn-sm" tabindex="-1">', function ($node, options) {
  ...
  */
  ...
  var Editor = function (context) {
      ...
      return async.createImage(src, param).then(function ($image) {
        ...
        if (typeof param === 'function') {
          ...
          if (typeof param === 'string') {
        	  $image.attr('id', 'content-image');
        	  $image.attr('filename', param);
          }
    ...
    this.removeMedia = this.wrapCommand(function () {
      ...
      filename = filename.substr(22);
      var front = filename.substr(0,12);
      var end = filename.substr(12);

      filename = front + "s~" + end;

      
      var small_selector = 'small[data-src="'+filename+'"]';
      $.ajax({
		   url:"/deleteFile",
		   type:"post",
		   ...
		   success:function(result){
			   if(result == 'deleted'){
				   $(small_selector).parent("div").remove();
  ...
  var Dropzone = function (context) {
    ...
    var $dropzone = $([
      '<div class="sjb note-dropzone">',
      '  <div class="sjb note-dropzone-message"/>',
      '</div>'
  ...
  var Handle = function (context) {
    ...
    this.initialize = function () {
      this.$handle = $([
        '<div class="sjb note-handle">',
        '<div class="sjb note-control-selection">',
        '<div class="sjb note-control-selection-bg"></div>',
        '<div class="sjb note-control-holder note-control-nw"></div>',
        '<div class="sjb note-control-holder note-control-ne"></div>',
        '<div class="sjb note-control-holder note-control-sw"></div>',
        '<div class="sjb ',
        (options.disableResizeImage ? 'note-control-holder' : 'note-control-sizing'),
        ' note-control-se"></div>',
        (options.disableResizeImage ? '' : '<div class="sjb note-control-selection-info"></div>'),
        '</div>',
        '</div>'
  ...
  var Placeholder = function (context) {
    ...
    this.initialize = function () {
      this.$placeholder = $('<div class="sjb note-placeholder">');
  ...
  var Buttons = function (context) {
    ...
    this.addToolbarButtons = function () {
        ...
        return ui.buttonGroup([
          ...
          ui.dropdown({
            ...
            template: function (item) {
              ...
              var className = item.className ? ' class="sjb ' + item.className + '"' : '';
      ...
      context.memo('button.fontname', function () {
        return ui.buttonGroup([
          ui.button({
            className: 'dropdown-toggle',
            contents: ui.dropdownButtonContents('<span class="sjb note-current-fontname"/>', options),
      ...
      context.memo('button.fontsize', function () {
        return ui.buttonGroup([
          ui.button({
            className: 'dropdown-toggle',
            contents: ui.dropdownButtonContents('<span class="sjb note-current-fontsize"/>', options),
      ...
      context.memo('button.color', function () {
        return ui.buttonGroup({
          ...
          children: [
            ...
            ui.dropdown({
              items: [
                '<div class="sjb note-palette">',
                '  <div class="sjb note-palette-title">' + lang.color.background + '</div>',
                '  <div>',
                '    <button type="button" class="sjb note-color-reset btn btn-light" data-event="backColor" data-value="inherit">',
                lang.color.transparent,
                '    </button>',
                '  </div>',
                '  <div class="sjb note-holder" data-event="backColor"/>',
                '</div>',
                '<div class="sjb note-palette">',
                '  <div class="sjb note-palette-title">' + lang.color.foreground + '</div>',
                '  <div>',
                '    <button type="button" class="sjb note-color-reset btn btn-light" data-event="removeFormat" data-value="foreColor">',
                lang.color.resetToDefault,
                '    </button>',
                '  </div>',
                '  <div class="sjb note-holder" data-event="foreColor"/>',
                '</div>'
              ].join(''),
      ...
      context.memo('button.table', function () {
        return ui.buttonGroup([
          ...
          ui.dropdown({
            ...
            items: [
              '<div class="sjb note-dimension-picker">',
              '  <div class="sjb note-dimension-picker-mousecatcher" data-event="insertTable" data-value="1x1"/>',
              '  <div class="sjb note-dimension-picker-highlighted"/>',
              '  <div class="sjb note-dimension-picker-unhighlighted"/>',
              '</div>',
              '<div class="sjb note-dimension-display">1 x 1</div>'
            ].join('')
          })
        ], {
    ...
    this.addImagePopoverButtons = function () {
      ...
      context.memo('button.imageSize100', function () {
        return ui.button({
          contents: '<span class="sjb note-fontsize-10">100%</span>',
      ...
      context.memo('button.imageSize50', function () {
        return  ui.button({
          contents: '<span class="sjb note-fontsize-10">50%</span>',
      ...
      context.memo('button.imageSize25', function () {
        return ui.button({
          contents: '<span class="sjb note-fontsize-10">25%</span>',
  ...
  var LinkDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="sjb form-group note-form-group">' +
                   '<label class="sjb note-form-label">' + lang.link.textToDisplay + '</label>' +
                   '<input class="sjb note-link-text form-control '+
                   ' note-form-control  note-input" type="text" />' +
                 '</div>' +
                 '<div class="sjb form-group note-form-group">' +
                   '<label class="sjb note-form-label">' + lang.link.url + '</label>' +
                   '<input class="sjb note-link-url form-control note-form-control ' +
      ...
      (!options.disableLinkTarget ?
          $('<div/>').append(ui.checkbox({ id: 'sn-checkbox-open-in-new-window', text: lang.link.openInNewWindow, checked: true }).render())
              .html()
          : '');
      var footer = '<button href="#" class="sjb btn btn-primary note-btn note-btn-primary ' +
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="sjb form-group note-form-group note-group-select-from-files">' +
                   '<label class="sjb note-form-label">' + lang.image.selectFromFiles + '</label>' +
                   '<input id="upload_form" class="sjb note-image-input form-control note-form-control note-input" '+
                   ' type="file" name="files" accept="image/*" multiple="multiple" />' +
                   imageLimitation +
                 '</div>' + 
                 '<div class="sjb form-group note-group-image-url" style="overflow:auto;">' +
                   '<label class="sjb note-form-label">' + lang.image.url + '</label>' +
                   '<input class="sjb note-image-url form-control note-form-control note-input ' +
                   ' col-md-12" type="text" />' +
                 '</div>';
      var footer = '<button href="#" class="sjb btn btn-primary note-btn note-btn-primary ' +
  ...
  var VideoDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="sjb form-group note-form-group row-fluid">' +
          '<label class="sjb note-form-label">' + lang.video.url + ' <small class="sjb text-muted">' + lang.video.providers + '</small></label>' +
          '<input class="sjb note-video-url form-control  note-form-control note-input span12" ' + 
          ' type="text" />' +
          '</div>';
      var footer = '<button href="#" class="sjb btn btn-primary note-btn note-btn-primary ' + 
  ...
  var HelpDialog = function (context) {
    ...
    this.createShortCutList = function () {
      ...
      return Object.keys(keyMap).map(function (key) {
        ...
        var $row = $('<div><div class="sjb help-list-item"/></div>');
  ...
  var HintPopover = function (context) {
    ...
    this.createItemTemplates = function (hintIdx, items) {
      ...
      return items.map(function (item, idx) {
        var $item = $('<div class="sjb note-hint-item"/>');
    ...
    this.createGroup = function (idx, keyword) {
      var $group = $('<div class="sjb note-hint-group note-hint-group-' + idx + '"/>');
